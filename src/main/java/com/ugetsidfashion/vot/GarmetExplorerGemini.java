...
@Qualifier("GarmetExplorerGemini")
@Component
public class GarmetExplorerGemini implements GarmetExplorer {
    private static final Logger logger = LoggerFactory.getLogger(GarmetExplorerGemini.class);
    ...
    public GarmetExplorerGemini(PromptGenerator promptGenerator, Client geminiClient) {
